...
% TRUNG: In this code, they use the first 2000 observation as burn-in
% observation. 
if isscalar(t)
    %t=t+2000;
    if strcmp(error_type,'NORMAL')
    ...
    elseif strcmp(error_type,'SKEWT')
        ...
        RandomNums=skewtrnd(nu,lambda,t,1); %Generate standardized Skew-t - to be used as z_t in mean equation
    else
...
h=UncondStd.^2*ones(t+m,1); % The first value of h_t is to use the unconditional volatility
