function [parameters, LL, errors, SEregression, diagnostics, output, VCVrobust, VCV, likelihoods, scores]=armaxfilter(y,constant,p,q,x,startingVals,options,holdBack,sigma2,estPars)
...
if nargout>=5
    ...
    output.SEregression = SEregression; 
    output.VCVrobust    = VCVrobust; 
    output.VCV          = VCV; 
